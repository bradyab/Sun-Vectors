Library for testing cubesat attitude determination algorithms using a Sparkfun MPU-9250 IMU and 6 sun sensors. Prototypes were created with Arduino, Monte Carlo testing performed in Matlab.
